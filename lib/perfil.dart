...
class _perfilState extends State<perfil> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      */
      //desde el center colocar todo en el Futurebuilder
      body: Center(
        child: Column(
                    ...
                    child: Container(
                      ...
                      child: ElevatedButton(onPressed: (){
                        Navigator.push(
                          ...
                          backgroundColor: Color.fromRGBO(44, 52, 62, 1),
                        ...
                        child: Padding(
                          ...
                          child: Text('Guardar datos', style: TextStyle(
                              fontSize: 20,
                              fontWeight: FontWeight.bold,
                              color: Colors.white
                          )),
              ...
              child: Container(
                ...
                child: ElevatedButton(onPressed: (){
                  Navigator.push(
                    ...
                    backgroundColor: Color.fromRGBO(250, 43, 43, 1),
                    shape: RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(7),
                    )
                ),
                  child: Padding(
                    padding: EdgeInsets.symmetric(horizontal: 10.0),
                    child: Text('Eliminar cuenta', style: TextStyle(
                        fontSize: 20,
                        fontWeight: FontWeight.bold,
                        color: Colors.white
                    )),
